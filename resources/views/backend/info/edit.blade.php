...
<div id="content" class="app-content">
    <div class="card">
        <div class="card-body p-0">
            <form method="post" action="{{ route('admin.info.update', $info->id) }}" enctype="multipart/form-data">
            @csrf
            <!-- BEGIN profile -->
            <div class="profile">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                value="{{ $info->name }}" placeholder="Company Name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                cols="30" rows="4" placeholder="Address">{{ $info->address }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                value="{{ $info->phone }}" placeholder="Phone Number">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                value="{{ $info->email }}" placeholder="Email">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="vat_number" class="form-control" id="email" 
                                                                value="{{ $info->vat_number }}" placeholder="VAT Registration Number">
                                                            </div>
                                                        </div>
                                                    </div>                                                                                                             
                                        ...
                                        <div class="mt-4 mb-3">
                                            <div class="row">
                                                <div class="col-sm-12 text-end">
                                                    <button type="submit" class="btn btn-outline-success">Update Company</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END -->                        
