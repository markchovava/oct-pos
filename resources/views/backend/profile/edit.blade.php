                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            @php($dob = explode(" ", $profile->date_of_birth))
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="address" class="form-control" value="{{ $profile->address }}" id="address" 
                                                                placeholder="Address">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="phone_number" value="{{ $profile->phone_number }}" class="form-control" id="phone_number" 
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select name="role_id" class="form-select" id="role">
                                                                    @foreach($roles as $role)
                                                                        <option value="{{ $role->level }}" {{ ($role->level == $profile->role_id) ? 'selected="selected"' : '' }}>
                                                                            {{ $role->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select name="info_id" class="form-select" id="role">
                                                                    ...
                                                                    <option value="{{ $info->id }}" {{ ($info->id == $profile->info_id) ? 'selected="selected"' : '' }}>
                                                                        {{ $info->name }}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
